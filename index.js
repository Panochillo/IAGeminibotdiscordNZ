        ...
        try {
            if (!interaction.replied && !interaction.deferred) {
                const errorEmbed = new EmbedBuilder()
                    ...
                    .setTitle('❌ Error')
                    .setDescription('Hubo un error al ejecutar este comando. Por favor intenta de nuevo.')
                    .setTimestamp();
                ...
                const errorEmbed = new EmbedBuilder()
                    .setColor(config.COLORS.ERROR)
                    .setTitle('❌ Error')
                    .setDescription('Hubo un error al procesar tu solicitud. Por favor intenta de nuevo.')
                    .setTimestamp();
